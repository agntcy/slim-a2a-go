...
func (defaultConverter) FromProtoCancelTaskRequest(req *a2agopb.CancelTaskRequest) (*a2a.CancelTaskRequest, error) {
	return pbconv.FromProtoCancelTaskRequest(req)
}

func (defaultConverter) FromProtoSubscribeToTaskRequest(req *a2agopb.SubscribeToTaskRequest) (*a2a.SubscribeToTaskRequest, error) {
...
func (defaultConverter) FromProtoCreateTaskPushConfigRequest(req *a2agopb.TaskPushNotificationConfig) (*a2a.CreateTaskPushConfigRequest, error) {
...
func (defaultConverter) FromProtoListTaskPushConfigRequest(req *a2agopb.ListTaskPushNotificationConfigsRequest) (*a2a.ListTaskPushConfigRequest, error) {
...
func (defaultConverter) FromProtoGetExtendedAgentCardRequest(req *a2agopb.GetExtendedAgentCardRequest) (*a2a.GetExtendedAgentCardRequest, error) {
...
func (defaultConverter) FromProtoListTaskPushConfigResponse(resp *a2agopb.ListTaskPushNotificationConfigsResponse) (*a2a.ListTaskPushConfigResponse, error) {
...
func (defaultConverter) ToProtoSubscribeToTaskRequest(req *a2a.SubscribeToTaskRequest) (*a2agopb.SubscribeToTaskRequest, error) {
...
func (defaultConverter) ToProtoCreateTaskPushConfigRequest(req *a2a.CreateTaskPushConfigRequest) (*a2agopb.TaskPushNotificationConfig, error) {
...
func (defaultConverter) ToProtoListTaskPushConfigRequest(req *a2a.ListTaskPushConfigRequest) (*a2agopb.ListTaskPushNotificationConfigsRequest, error) {
...
func (defaultConverter) ToProtoGetExtendedAgentCardRequest(req *a2a.GetExtendedAgentCardRequest) (*a2agopb.GetExtendedAgentCardRequest, error) {
...
func (defaultConverter) ToProtoListTaskPushConfigResponse(resp *a2a.ListTaskPushConfigResponse) (*a2agopb.ListTaskPushNotificationConfigsResponse, error) {
