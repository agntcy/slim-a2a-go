...
func (t *Transport) SubscribeToTask(
	...
	return func(yield func(a2a.Event, error) bool) {
		pbReq, err := t.conv.ToProtoSubscribeToTaskRequest(req)
		if err != nil {
			yield(nil, err)
			return
		}
...
func (t *Transport) ListTaskPushConfigs(
	...
	domainResp, err := t.conv.FromProtoListTaskPushConfigResponse(resp)
	if err != nil {
		return nil, err
	}
...
func (t *Transport) GetExtendedAgentCard(
	...
	pbReq, err := t.conv.ToProtoGetExtendedAgentCardRequest(req)
	if err != nil {
		return nil, err
	}
